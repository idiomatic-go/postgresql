...
The processing of host generated messaging for startup and ping events is also supported. Scanning of PostgreSQL rows into application types is implemented
with a templated interface, and a corresponding templated Scan function.
